  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'メールアドレスは、@を含む必要があること' do
        @user.email = 'jfhdgmail.com'
        @user.valid?
        expect(@user.errors.full_messages).to include("Email is invalid")
      end

      it 'passwordとpassword_confirmationが５文字以下であれば登録できない' do
        @user.password = '12345'
      ...
      it 'passwordとpassword_confirmationは、半角英数字混合での入力が必須であること' do
        @user.password = '１２３４５６', 'abcdefg'
        @user.password_confirmation = '１２３４５６', 'abcdefg'
        @user.valid?
